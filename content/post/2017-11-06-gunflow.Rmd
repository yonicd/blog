...
This exploratory analysis will hopefully be a good starting point for some modeling of firearm flow between states and developing sound models to predict the flow of firearms between states using R.